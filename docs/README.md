...
- `docs/orfe/spec.md`
  ...
  - includes the canonical template model for issue and PR artifact validation/provenance
...
## Repo-local template artifacts

- `.orfe/templates/`
  - versioned declarative issue and PR templates consumed by `orfe`
...
- Repo-defined issue/PR template rules: read `docs/orfe/spec.md` and `docs/architecture/invariants.md`
